      ...
      <SidebarContext.Provider value={contextValue}>
        <TooltipProvider delayDuration={0}>
          <div
            style={
              {
                // Define CSS variables explicitly in the style object
        ...
        <div
          className={cn(
            ...
            state === 'collapsed' &&
              ...
              ? 'w-[3rem]'
              : 'w-[16rem]',
            side === 'left' && variant !== 'floating' && variant !== 'inset'
              ? 'border-r'
              : '',
            side === 'right' && variant !== 'floating' && variant !== 'inset'
              ? 'border-l'
              : '',
            className
          )}
