...
export default function RercruiterEditForm({
  initialData,
  pageTitle
}: {
  initialData: TRecruiter | null;
  pageTitle: string;
}) {
  const defaultValues = {
  ...
  async function onSubmit(values: TUpdateRecruiter) {
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className='space-y-8'>
            ...
            <div className='grid grid-cols-1 gap-6 md:grid-cols-2'>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>Số lượng nhân sự</FormLabel>
                    <FormControl>
            ...
            <Button type='submit'>Sửa nhà tuyển dụng</Button>
          </form>
        </Form>
      </CardContent>
    </Card>
