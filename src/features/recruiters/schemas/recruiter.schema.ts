...
export const RecruiterListResSchema = z.object({
  data: z.array(RecruiterSchema),
  message: z.string()
});

export type TRecruiterListRes = z.TypeOf<typeof RecruiterListResSchema>;
...
export type TAddRecruiter = z.TypeOf<typeof AddRecruiterSchema>;
